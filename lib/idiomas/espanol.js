...
const smsAvisoLogro = () => { return `🌟 *𝓛𝓸𝓰𝓻𝓸 * 🌟\n\n` }
const smsAvisoPrecaucion = () => { return `⚡️ *𝓟𝓻𝓮𝓬𝓪𝓾𝓬𝓲ó𝓷* ⚡️\n\n` }
const smsAvisoInformacion = () => { return `🔍 *𝓘𝓷𝓯𝓸𝓻𝓶𝓪𝓬𝓲ó𝓷* 🔍\n\n` }
const smsAvisoError = () => { return `❗️ *𝓔𝓻𝓻𝓸𝓻* ❗️\n\n` }
const smsAvisoAccionIncorrecta = () => { return `🚨 *𝓐𝓬𝓬𝓲ó𝓷 𝓜𝓪𝓵 𝓤𝓼𝓪𝓭𝓪* 🚨\n\n` }
const smsAvisoReporte = () => { return `📢 *𝓡𝓮𝓹𝓸𝓻𝓽𝓮* 📢\n\n` }
const smsAvisoExito = () => { return `✨ *𝓔𝔁𝓲𝓽𝓸* ✨\n\n` }

const smsRowner = () => { return `⚠️ *¡¡𝓔𝓢𝓣𝓔 𝓒𝓞𝓜𝓐𝓝𝓓𝓞 𝓢Ó𝓛𝓞 𝓔𝓛 𝓝Ú𝓜𝓔𝓡𝓞 𝓓𝓔𝓛 𝓑𝓞𝓣 𝓟𝓤𝓔𝓓𝓔 𝓤𝓢𝓐𝓡!!* ⚠️` }
const smsOwner = () => { return `⚠️ *¡¡𝓔𝓢𝓣𝓔 𝓒𝓞𝓜𝓐𝓝𝓓𝓞 𝓢Ó𝓛𝓞 𝓜𝓘 𝓒𝓡𝓔𝓐𝓓𝓞𝓡 𝓛𝓞 𝓟𝓤𝓔𝓓𝓔 𝓤𝓢𝓐𝓡!!* ⚠️` }
const smsMods = () => { return `⚠️ *¡¡𝓔𝓢𝓣𝓔 𝓒𝓞𝓜𝓐𝓝𝓓𝓞 𝓢Ó𝓛𝓞 𝓜𝓞𝓓𝓔𝓡𝓐𝓓𝓞𝓡𝓔𝓢 𝓨 𝓜𝓘 𝓒𝓡𝓔𝓐𝓓𝓞𝓡 𝓛𝓞 𝓟𝓤𝓔𝓓𝓔𝓝 𝓤𝓢𝓐𝓡!!* ⚠️` }
const smsPremium = () => { return `⚠️ *¡¡𝓔𝓢𝓣𝓔 𝓒𝓞𝓜𝓐𝓝𝓓𝓞 𝓢Ó𝓛𝓞 𝓔𝓢𝓣𝓐 𝓓𝓘𝓢𝓟𝓞𝓝𝓘𝓑𝓛𝓔 𝓟𝓐𝓡𝓐 𝓤𝓢𝓤𝓐𝓡𝓘𝓞𝓢 𝓟𝓡𝓔𝓜𝓘𝓤𝓜 𝓨 𝓜𝓘 𝓒𝓡𝓔𝓐𝓓𝓞(𝓐)!!* ⚠️` }
const smsGroup = () => { return `⚠️ *¡¡𝓔𝓢𝓣𝓔 𝓒𝓞𝓜𝓐𝓝𝓓𝓞 𝓢Ó𝓛𝓞 𝓢𝓔 𝓟𝓤𝓔𝓓𝓔 𝓤𝓣𝓘𝓛𝓘𝓩𝓐𝓡 𝓔𝓝 𝓖𝓡𝓤𝓟𝓞𝓢!!* ⚠️` }
const smsPrivate = () => { return `⚠️ *¡¡𝓔𝓢𝓣𝓔 𝓒𝓞𝓜𝓐𝓝𝓓𝓞 𝓢Ó𝓛𝓞 𝓢𝓔 𝓟𝓤𝓔𝓓𝓔 𝓤𝓣𝓘𝓛𝓘𝓩𝓐𝓡 𝓐𝓛 𝓟𝓡𝓘𝓥𝓐𝓓𝓞!!* ⚠️` }
const smsAdmin = () => { return `⚠️ *¡¡𝓔𝓢𝓣𝓔 𝓒𝓞𝓜𝓐𝓝𝓓𝓞 𝓢Ó𝓛𝓞 𝓔𝓢 𝓟𝓐𝓡𝓐 𝓐𝓓𝓜𝓘𝓝𝓢!!* ⚠️` }
const smsBotAdmin = () => { return `⚠️ *¡¡𝓝𝓔𝓒𝓔𝓢𝓘𝓣𝓞 𝓢𝓔𝓡 𝓐𝓓𝓜𝓘𝓝 𝓟𝓐𝓡𝓐 𝓠𝓤𝓔 𝓟𝓤𝓔𝓓𝓐𝓢 𝓤𝓢𝓐𝓡 𝓔𝓛 𝓒𝓞𝓜𝓐𝓝𝓓𝓞!!* ⚠️` }
const smsUnreg = () => { return `⚠️ *¡¡𝓝𝓔𝓒𝓔𝓢𝓘𝓣𝓐𝓢 𝓔𝓢𝓣𝓐𝓡 𝓡𝓔𝓖𝓘𝓢𝓣𝓡𝓐𝓓𝓞(𝓐) 𝓟𝓐𝓡𝓐 𝓤𝓢𝓐𝓡 𝓔𝓢𝓣𝓔 𝓒𝓞𝓜𝓐𝓝𝓓𝓞, 𝓔𝓢𝓒𝓡𝓘𝓑𝓔 #𝓿𝓮𝓻𝓲𝓯𝓲𝓬𝓪𝓻 𝓟𝓐𝓡𝓐 𝓡𝓔𝓖𝓘𝓢𝓣𝓡𝓐𝓡𝓣𝓔!!* ⚠️` }
const smsRestrict = () => { return `⚠️ *¡¡𝓔𝓢𝓣𝓔 𝓒𝓞𝓜𝓐𝓝𝓓𝓞 𝓔𝓢𝓣𝓐 𝓓𝓘𝓢𝓟𝓞𝓝𝓘𝓑𝓛𝓔 𝓟𝓞𝓡 𝓒𝓡𝓔𝓐𝓓𝓞𝓡⚠️⚠️}\`\`\`` }
...
*┊✨ ¡𝐁𝐈𝐄𝐍𝐕𝐄𝐍𝐈𝐃𝐎(𝐀)!*
┊💖 @user
┊📄 <span style="font-family: 'Arial', sans-serif;">𝐋𝐄𝐀 𝐋𝐀 𝐃𝐄𝐒𝐂𝐑𝐈𝐏𝐂𝐈Ó𝐍 𝐃𝐄𝐋 𝐆𝐑𝐔𝐏𝐎</span> 📄
*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈ ✦*
${String.fromCharCode(8206).repeat(850)}
@desc 📝
🌟🌈🌼 ¡𝐐𝐮𝐞 𝐜𝐨𝐦𝐢𝐞𝐧𝐜𝐞 𝐥𝐚 𝐚𝐯𝐞𝐧𝐭𝐮𝐫𝐚 𝐞𝐧 𝐞𝐬𝐭𝐞 𝐠𝐫𝐮𝐩𝐨! 🌼🌈🌟
`;
}
const smsBye = () => {
    return `
*╭┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*
┊ *@user*
┊ *𝐍𝐎 𝐅𝐔𝐄 𝐃𝐈𝐆𝐍𝐎(𝐀) 𝐃𝐄 𝐏𝐄𝐑𝐌𝐀𝐍𝐄𝐂𝐄𝐑 𝐀𝐐𝐔Í* 🌟
*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*
👋🏼🚀 ¡𝐇𝐚𝐬𝐭𝐚 𝐥𝐮𝐞𝐠𝐨! ¡𝐄𝐬𝐩𝐞𝐫𝐚𝐦𝐨𝐬 𝐯𝐞𝐫𝐭𝐞 𝐩𝐫𝐨𝐧𝐭𝐨 𝐧𝐮𝐞𝐯𝐚𝐦𝐞𝐧𝐭𝐞! 🚀👋🏼
`;
}
const smsSpromote = () => { return '*@user HA SIDO PROMOVIDO(A) COMO ADMINISTRADOR(A) DEL GRUPO!!*' }
const smsSdemote = () => { return '*@user HA SIDO DEGRADADO(A) COMO ADMINISTRADOR(A) DEL GRUPO!!*' }
...
const smsConexionOFF = () => { return `\n⚠️ SIN CONEXIÓN, BORRA LA CARPETA ${global.authFile} Y ESCANEA EL CÓDIGO QR ⚠️` }
...
//_antiprivado
const smsprivado = () => { return `*NO PUEDES USAR ESTE BOT EN UN CHAT PRIVADO*\n\n*Únete al Grupo oficial del bot para poder usar el bot*` }
...
const smsCreC = () => { return 'Siempre a tu disposición para ayudarte' }

//info-cuentas-oficiales.js
const smsOfc1 = () => { return 'Cuenta oficial' }
const smsOfc2 = () => { return `Sígueme en las Cuentas Oficiales para mantenerte al tanto de ${packname}` }

//info-donar.js
const smsMensajeDonar = () => { return `🌼 Aceptamos donaciones voluntarias a través de PayPal. Si deseas apoyar de otra forma, puedes donar un número en Instagram para mantener el repositorio activo. ¡Gracias!\n\n🌺 Siempre puedes apoyarnos siguiendo las Cuentas Oficiales y compartiendo el trabajo logrado en ${packname}` }
const smsTituloDonar = () => { return '*◜🌹❤️ DONACIÓN VOLUNTARIA ❤️🌹◞*' }
const smsPrivadoDonar = () => { return '🍄 *_También puedes compartir lo siguiente como Muestra de Apoyo_*\n*_¡Califica el repositorio con una 🌟, gracias!_*' }
...
const smsContacto4 = () => { return 'Contacto Oficial de Manubot'}
...
//buscadores.js
const smsGit1 = (usedPrefix, command) => { return `🔍 *BUSCAR EN GITHUB*\n*EJEMPLO*\n\n*${usedPrefix + command}* UsuarioGitHub`}
...
const smsGit7 = () => { return '🌐 *SITIOS WEB*'}
const smsGit8 = () => { return '📚 *REPOSITORIOS PÚBLICOS*'}
const smsGit9 = () => { return '🌟 *HIGHLIGHTS PÚBLICOS*'}
const smsGit10 = () => { return '👥 *SEGUIDORES*'}
const smsGit11 = () => { return '👁️ *SIGUIENDO*'}
const smsGit12 = () => { return '📍 *UBICACIÓN*'}
const smsGit13 = () => { return '📌 *TIPO*'}
const smsGit14 = () => { return '🚫 *NO ENCONTRADO*'}


// jadibot-serbot.js
const smsIniJadi = () => { return `🔮 *INICIALIZANDO JadiBot* 🔮\n\n📦 *PACK: ${global.packname}*\n🔖 *VERSIÓN: ${global.vs}*\n\n🟢 *_FUNCIÓN SER SUB BOT_* 🟢\n\n*➡️ Escanea este QR con otro dispositivo para convertirte en Sub Bot*\n\n1️⃣ Toca los tres puntos en la esquina superior derecha\n2️⃣ Ve a Dispositivos vinculados\n3️⃣ Escanea el código QR para iniciar sesión\n\n📢 *Este QR expira en 45 segundos!*`}
const smsSoloOwnerJB = () => { return `${lenguajeGB['smsAvisoAG']()}*ESTE COMANDO ESTÁ DESHABILITADO POR EL PROPIETARIO*`}
const smsJBPrincipal = () => { return `${lenguajeGB['smsAvisoAG']()}🟢 *PARA SER SUB BOT, DIRÍGETE AL NÚMERO PRINCIPAL*\n🔗 *Accede al siguiente enlace:*\n`}
...
//handler.js
const smsCont1 = () => { return `*⚠️ ERROR EN EL COMANDO ⚠️*`}
...
const smsCont6 = () => { return `*✨ REPORTA ESTE MENSAJE USANDO #reporte PARA SOLUCIONARLO*`}
const smsCont7 = () => { return `${global.lenguajeGB['smsAvisoAG']()}*NO TIENES DIAMANTES 💎. PUEDES IR A LA TIENDA USANDO EL COMANDO*`}
const smsCont8 = () => { return ` *DIAMANTES 💎 USADOS*`}
const smsCont9 = () => { return `${global.lenguajeGB['smsAvisoAG']()}*NECESITAS NIVEL ➡️*`}
...
const smsHandler = () => { return "¡Se actualizó 'handler.js' con éxito!"}
...
//menu-menu.js
const smsMenuTotal1 = () => { return "𝐏𝐀𝐍𝐄𝐋 𝐃𝐄 𝐈𝐍𝐅𝐎𝐑𝐌𝐀𝐂𝐈Ó𝐍" }
const smsMenuTotal2 = () => { return "𝐁𝐎𝐓 𝐏𝐄𝐑𝐒𝐎𝐍𝐀𝐋" }
const smsMenuTotal3 = () => { return "𝐁Ú𝐒𝐐𝐔𝐄𝐃𝐀 / 𝐈𝐍𝐓𝐄𝐋𝐈𝐆𝐄𝐍𝐂𝐈𝐀 𝐀𝐑𝐓𝐈𝐅𝐈𝐂𝐈𝐀𝐋" }
const smsMenuTotal4 = () => { return "𝐃𝐄𝐒𝐂𝐀𝐑𝐆𝐀𝐒 𝐘 𝐀𝐑𝐂𝐇𝐈𝐕𝐎𝐒" }
const smsMenuTotal5 = () => { return "𝐂𝐎𝐍𝐕𝐄𝐑𝐒𝐈Ó𝐍 𝐃𝐄 𝐅𝐎𝐑𝐌𝐀𝐓𝐎𝐒" }
const smsMenuTotal6 = () => { return "𝐆𝐑𝐔𝐏𝐎 ~ 𝐓𝐎𝐃𝐎𝐒 𝐋𝐎𝐒 𝐌𝐈𝐄𝐌𝐁𝐑𝐎𝐒" }
const smsMenuTotal7 = () => { return "𝐆𝐑𝐔𝐏𝐎 ~ 𝐀𝐃𝐌𝐈𝐍𝐈𝐒𝐓𝐑𝐀𝐃𝐎𝐑𝐄𝐒" }
const smsMenuTotal8 = () => { return "𝐌𝐎𝐃𝐈𝐅𝐈𝐂𝐀𝐑 𝐄𝐅𝐄𝐂𝐓𝐎𝐒 𝐃𝐄 𝐒𝐎𝐍𝐈𝐃𝐎" }
const smsMenuTotal9 = () => { return "𝐄𝐅𝐄𝐂𝐓𝐎𝐒 𝐃𝐄 𝐀𝐔𝐃𝐈𝐎" }
const smsMenuTotal10 = () => { return "𝐂𝐎𝐍𝐅𝐈𝐆𝐔𝐑𝐀𝐂𝐈Ó𝐍 𝐏𝐄𝐑𝐒𝐎𝐍𝐀𝐋" }
const smsMenuTotal11 = () => { return "𝐕𝐄𝐑𝐈𝐅𝐈𝐂𝐀𝐂𝐈Ó𝐍 𝐃𝐄 𝐔𝐒𝐔𝐀𝐑𝐈𝐎" }
const smsMenuTotal12 = () => { return "𝐏𝐑𝐎𝐏𝐈𝐄𝐓𝐀𝐑𝐈𝐎" }

//Error2
const smsMensError1 = () => { return `❌ 𝐑𝐄𝐏𝐎𝐑𝐓𝐀𝐑 𝐄𝐑𝐑𝐎𝐑 ❌`} 
const smsMensError2 = () => { return `¡Oh no! Parece que algo no salió como se planeaba`}  

//config.js
const smsMeWait = () => { return '* ⏰ 𝐄𝐒𝐏𝐄𝐑𝐄 𝐔𝐍 𝐌𝐎𝐌𝐄𝐍𝐓𝐎 𝐏𝐎𝐑 𝐅𝐀𝐕𝐎𝐑 ⏰*'} 

//buscadores.js
const smsytserh1 = () => { return '𝐓Í𝐓𝐔𝐋𝐎'} 
const smsytserh2 = () => { return '𝐄𝐍𝐋𝐀𝐂𝐄'} 
const smsytserh3 = () => { return '𝐃𝐔𝐑𝐀𝐂𝐈Ó𝐍'} 
const smsytserh4 = () => { return '𝐒𝐔𝐁𝐈𝐃𝐎'} 
const smsytserh5 = () => { return '𝐕𝐈𝐒𝐓𝐀𝐒'} 

//descargas.js
const smsIAimage = () => { return ' 𝐈𝐌𝐀𝐆𝐄𝐍 𝐂𝐑𝐄𝐀𝐃𝐀 𝐂𝐎𝐍 𝐈𝐀/𝐃𝐀𝐋𝐋-𝐄 ' }
const smsIAimage2 = () => { return '𝒰𝓃 𝑔𝒶𝓉𝑜 𝒹𝑒 𝒸𝑜𝓁𝑜𝓇 𝓂𝑜𝓇𝒶𝒹𝑜 𝒸𝑜𝓃 𝒸𝑒𝓁𝑒𝓈𝓉𝑒 𝑒𝓈𝓉𝒶𝓃𝒹𝑜 𝑒𝓃 𝒥𝓊𝓅𝒾𝓉𝑒𝓇, 𝒾𝓁𝓊𝓂𝒾𝓃𝒶𝓃𝒹𝑜 𝑒𝓁 𝒸𝑜𝓈𝓂𝑜 𝒸𝑜𝓃 𝓈𝓊 𝑒𝓃𝒸𝒶𝓃𝓉𝑜 𝒸𝑜𝓃 𝓊𝓃 𝑒𝒻𝑒𝒸𝓉𝑜 𝓂𝒾𝓃𝒾𝓂𝒶𝓁𝒾𝓈𝓉𝒶.' }
const smsIAimage3 = () => { return '💻 𝐈𝐌𝐀𝐆𝐄𝐍 𝐂𝐑𝐄𝐀𝐃𝐀 𝐂𝐎𝐍 𝐈𝐀/M𝐢𝐝𝐣𝐨𝐮𝐫𝐧𝐞𝐲 ' }
const smsIAimage4 = () => { return '𝒰𝓃 𝓁𝑒ó𝓃 𝒷𝑒𝒷é, 𝒸𝑜𝓇𝓇𝑒 𝓅𝑜𝓇 𝑒𝓁 𝒸𝒽𝒶𝓇𝒸𝑜, 𝓈𝑒 𝓇𝑒𝒻𝓁𝑒𝒿𝒶 𝑒𝓃 𝑒𝓁 𝒸𝒽𝒶𝓇𝒸𝑜, 𝒻𝑜𝓉𝑜𝑔𝓇𝒶𝒻í𝒶.' }
 

//descargas.js
const smsyFBvid1 = () => { return '*𝑵𝑶 𝑬𝑺 𝑼𝑵 𝑬𝑵𝑳𝑨𝑪𝑬 𝑽𝑨́𝑳𝑰𝑫𝑶, 𝑹𝑬𝑪𝑼𝑬𝑹𝑫𝑬 𝑼𝑺𝑨𝑹 𝑼𝑵 𝑬𝑵𝑳𝑨𝑪𝑬 𝑫𝑬 𝑽𝑰́𝑫𝑬𝑶 𝑫𝑬 𝑭𝑨𝑪𝑬𝑩𝑶𝑶𝑲*'}
const smsyFBvid2 = () => { return '𝑽𝑰́𝑫𝑬𝑶 𝑫𝑬 𝑮𝑹𝑼𝑷𝑶 𝑫𝑬 𝑭𝑨𝑪𝑬𝑩𝑶𝑶𝑲 𝑫𝑬𝑺𝑪𝑨𝑹𝑮𝑨𝑫𝑶 '}
const smsyFBvid3 = () => { return '𝑹𝑬𝑬𝑳 𝑫𝑬 𝑭𝑨𝑪𝑬𝑩𝑶𝑶𝑲 𝑫𝑬𝑺𝑪𝑨𝑹𝑮𝑨𝑫𝑶 '}
const smsyFBvid4 = () => { return '𝑯𝑰𝑺𝑻𝑶𝑹𝑰𝑨 𝑫𝑬 𝑭𝑨𝑪𝑬𝑩𝑶𝑶𝑲 𝑫𝑬𝑺𝑪𝑨𝑹𝑮𝑨𝑫𝑨 '}
const smsyFBvid5 = () => { return '𝑽𝑰́𝑫𝑬𝑶 𝑫𝑬 𝑷𝑼𝑩𝑳𝑰𝑪𝑨𝑪𝑰𝑶𝑵𝑬𝑺 𝑫𝑬 𝑭𝑨𝑪𝑬𝑩𝑶𝑶𝑲 𝑫𝑬𝑺𝑪𝑨𝑹𝑮𝑨𝑫𝑶 '}
const smsyFBvid6 = () => { return '𝑽𝑰́𝑫𝑬𝑶 𝑫𝑬 𝑭𝑨𝑪𝑬𝑩𝑶𝑶𝑲 𝑫𝑬 𝑫𝑬𝑺𝑪𝑨𝑹𝑮𝑨𝑫𝑶  '}


//grupos-admin.js
const smsInvite1 = () => { return '*𝑺𝑶𝑳𝑶 𝑺𝑬 𝑨𝑪𝑬𝑷𝑻𝑨𝑵 𝑫𝑰𝑮𝑰𝑻𝑶𝑺, 𝑵𝑶 𝑳𝑬𝑻𝑹𝑨𝑺*'}
const smsInvite2 = (usedPrefix, command, bot) => { return `*𝑰𝑵𝑮𝑹𝑬𝑺𝑬 𝐸𝐿 𝑁𝑈𝑀𝐸𝑅𝑂 𝐶𝑂𝑀𝑃𝐿𝐸𝑇𝑂 𝐷𝐸𝐿 𝑈𝑆𝑈𝐴𝑅𝐼𝑂 𝑄𝑈𝐸 𝑄𝑈𝐼𝐸𝑅𝐸𝑆 𝐼𝑁𝑉𝐼𝑇𝐴𝑅 𝐴𝐿 𝐺𝑅𝑈𝑃𝑂*\n*𝐸𝐽𝐸𝑀𝑃𝐿𝑂:*\n\n*${usedPrefix + command}* +${bot}`} 
const smsInvite3 = (NumeroUser, user, groupMetadata, link) => { return `✨ ¡𝐻𝑜𝑙𝑎! *@${NumeroUser}* 𝑆𝑜𝑦 ${packname}, 𝑢𝑛 𝐵𝑜𝑡 𝑝𝑎𝑟𝑎 𝑊ℎ𝑎𝑡𝑠𝐴𝑝𝑝. 𝑃𝑎𝑟𝑒𝑐𝑒 𝑞𝑢𝑒 *@${user}* 𝑡𝑒 𝑒𝑠𝑡á 𝑖𝑛𝑣𝑖𝑡𝑎𝑛𝑑𝑜 𝑎𝑙 𝐺𝑟𝑢𝑝𝑜 ${groupMetadata.subject}\n\n\`\`\`¡𝑇𝑒 𝑒𝑠𝑝𝑒𝑟𝑎𝑚𝑜𝑠 𝑐𝑜𝑛 𝑎𝑛𝑠𝑖𝑎𝑠 𝑒𝑛 𝑒𝑙 𝑔𝑟𝑢𝑝𝑜!\`\`\`\n\n*${link}*`} 
const smsInvite4 = (NumeroUser) => { return `*𝐼𝑁𝑉𝐼𝑇𝐴𝐶𝐼𝑂́𝑁 𝐸𝑁𝑉𝐼𝐴𝐷𝐴 𝐴𝐿 𝑃𝑅𝐼𝑉𝐴𝐷𝑂 𝐷𝐸 @${NumeroUser}*`}


//descargas.js
const smsSP0 = (usedPrefix) => { return `🎵 _𝐔𝐬𝐞 *${usedPrefix}spotifysearch* 𝐭𝐨 𝐟𝐢𝐧𝐝 𝐭𝐡𝐞 𝐒𝐩𝐨𝐭𝐢𝐟𝐲 𝐬𝐨𝐧𝐠 𝐥𝐢𝐧𝐤_`} 
const smsSP1 = () => { return '🎶 *𝐓Í𝐓𝐋𝐎:*'} 
const smsSP2 = () => { return '🎤 *𝐀𝐑𝐓𝐈𝐒𝐓𝐀:*'} 
const smsSP3 = () => { return '🌐 *𝐋𝐈𝐍𝐊:*'} 
const smsSP4 = () => { return '🔄 *𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃 𝐋𝐈𝐍𝐊:*'} 
const smsSP5 = () => { return '🎵 *𝐄𝐍𝐕𝐈𝐀𝐍𝐃𝐎 𝐂𝐀𝐍𝐂𝐈Ó𝐍...*'} 
const smsSP6 = () => { return `${lenguajeGB['smsAvisoFG']()}*𝐍𝐨 𝐒𝐞 𝐄𝐧𝐜𝐨𝐧𝐭𝐫𝐚𝐫𝐨𝐧 𝐑𝐞𝐬𝐮𝐥𝐭𝐚𝐝𝐨𝐬.*`}


//_autodetec.js
const smsAutodetec1 = (inf, usuario, m) => { return `${inf}🔔 *¡𝑨𝒄𝒕𝒖𝒂𝒍𝒊𝒛𝒂𝒄𝒊𝒐́𝒏 𝒅𝒆 𝒏𝒐𝒎𝒃𝒓𝒆!* 🔔\n\n📣 *${usuario}* 𝒉𝒂 𝒎𝒐𝒅𝒊𝒇𝒊𝒄𝒂𝒅𝒐 𝒆𝒍 𝒏𝒐𝒎𝒃𝒓𝒆 𝒅𝒆𝒍 𝒈𝒓𝒖𝒑𝒐.\n\n🌟 *Nuevo nombre:* ${m.messageStubParameters[0]}` }
const smsAutodetec2 = (inf, usuario, groupMetadata) => { return `${inf}🖼️ *𝑪𝒂𝒎𝒃𝒊𝒐 𝒅𝒆 𝒊𝒎𝒂𝒈𝒆𝒏 𝒓𝒆𝒂𝒍𝒊𝒛𝒂𝒅𝒐* 🖼️\n\n💬 *${usuario}* 𝒉𝒂 𝒄𝒂𝒎𝒃𝒊𝒂𝒅𝒐 𝒍𝒂 𝒊𝒎𝒂𝒈𝒆𝒏 𝒅𝒆𝒍 𝒈𝒓𝒖𝒑𝒐 ${groupMetadata.subject}` }
const smsAutodetec3 = (inf, usuario, m, groupMetadata) => { return `${inf}👑 *¡𝑵𝒖𝒆𝒗𝒂𝒔 𝒓𝒆𝒈𝒍𝒂𝒔!* 👑\n\n📢 *${usuario}* 𝒉𝒂 𝒂𝒋𝒖𝒔𝒕𝒂𝒅𝒐 𝒍𝒂 𝒄𝒐𝒏𝒇𝒊𝒈𝒖𝒓𝒂𝒄𝒊𝒐́𝒏 𝒑𝒂𝒓𝒂 𝒒𝒖𝒆 ${m.messageStubParameters[0] == 'on' ? '𝒔𝒐𝒍𝒐 𝒍𝒐𝒔 𝒂𝒅𝒎𝒊𝒏𝒊𝒔𝒕𝒓𝒂𝒅𝒐𝒓𝒆𝒔' : '𝒕𝒐𝒅𝒐𝒔 𝒍𝒐𝒔 𝒎𝒊𝒆𝒎𝒃𝒓𝒐𝒔'} 𝒑𝒖𝒆𝒅𝒂𝒏 𝒆𝒅𝒊𝒕𝒂𝒓 𝒍𝒂𝒔 𝒏𝒐𝒓𝒎𝒂𝒔 𝒅𝒆𝒍 𝒈𝒓𝒖𝒑𝒐 ${groupMetadata.subject}` }
const smsAutodetec4 = (inf, groupMetadata, usuario) => { return `${inf}🔗 *𝑬𝒏𝒍𝒂𝒄𝒆 𝒓𝒆𝒔𝒕𝒂𝒃𝒍𝒆𝒄𝒊𝒅𝒐* 🔗\n\n🔄 𝑬𝒍 𝒆𝒏𝒍𝒂𝒄𝒆 𝒅𝒆𝒍 𝒈𝒓𝒖𝒑𝒐 ${groupMetadata.subject} 𝒉𝒂 𝒔𝒊𝒅𝒐 𝒓𝒆𝒔𝒕𝒂𝒃𝒍𝒆𝒄𝒊𝒅𝒐 𝒑𝒐𝒓 ${usuario}` }
const smsAutodetec5 = (inf, groupMetadata, m, usuario) => { return `${inf}💬 *𝑵𝒖𝒆𝒗𝒐 𝒆𝒔𝒕𝒂𝒅𝒐 𝒅𝒆 𝒄𝒉𝒂𝒕* 💬\n\n🔒 𝑬𝒍 𝒄𝒉𝒂𝒕 𝒅𝒆𝒍 𝒈𝒓𝒖𝒑𝒐 ${groupMetadata.subject} 𝒉𝒂 𝒔𝒊𝒅𝒐 ${m.messageStubParameters[0] == 'on' ? '𝒃𝒍𝒐𝒒𝒖𝒆𝒂𝒅𝒐' : '𝒅𝒆𝒔𝒃𝒍𝒐𝒒𝒖𝒆𝒂𝒅𝒐'} 𝒑𝒐𝒓 ${usuario}\n\n🚦 ${m.messageStubParameters[0] == 'on' ? '𝑺𝒐𝒍𝒐 𝒍𝒐𝒔 𝒂𝒅𝒎𝒊𝒏𝒊𝒔𝒕𝒓𝒂𝒅𝒐𝒓𝒆𝒔' : '𝑻𝒐𝒅𝒐𝒔 𝒍𝒐𝒔 𝒎𝒊𝒆𝒎𝒃𝒓𝒐𝒔'} 𝒑𝒖𝒆𝒅𝒆𝒏 𝒆𝒏𝒗𝒊𝒂𝒓 𝒎𝒆𝒏𝒔𝒂𝒋𝒆𝒔 𝒂𝒉𝒐𝒓𝒂` }
const smsAutodetec6 = (inf, m, groupMetadata, usuario) => { return `${inf}👤 *𝑵𝒖𝒆𝒗𝒐 𝒂𝒅𝒎𝒊𝒏𝒊𝒔𝒕𝒓𝒂𝒅𝒐𝒓* 👤\n\n🌟 ¡@${m.messageStubParameters[0].split`@`[0]} 𝒔𝒆 𝒉𝒂 𝒄𝒐𝒏𝒗𝒆𝒓𝒕𝒊𝒅𝒐 𝒆𝒏 𝒂𝒅𝒎𝒊𝒏𝒊𝒔𝒕𝒓𝒂𝒅𝒐𝒓 𝒅𝒆 ${groupMetadata.subject}\n\n🎉 𝑨𝒄𝒄𝒊𝒐́𝒏 𝒓𝒆𝒂𝒍𝒊𝒛𝒂𝒅𝒂 𝒑𝒐𝒓: ${usuario}` }
const smsAutodetec7 = (inf, m, groupMetadata, usuario) => { return `${inf}🙅 *𝑨𝒅𝒎𝒊𝒏𝒊𝒔𝒕𝒓𝒂𝒅𝒐𝒓 𝒓𝒆𝒕𝒊𝒓𝒂𝒅𝒐* 🙅\n\n🔹 @${m.messageStubParameters[0].split`@`[0]} 𝒚𝒂 𝒏𝒐 𝒆𝒔 𝒂𝒅𝒎𝒊𝒏𝒊𝒔𝒕𝒓𝒂𝒅𝒐𝒓 𝒅𝒆 ${groupMetadata.subject}\n\n🔸 𝑨𝒄𝒄𝒊𝒐́𝒏 𝒓𝒆𝒂𝒍𝒊𝒛𝒂𝒅𝒂 𝒑𝒐𝒓: ${usuario}` }
